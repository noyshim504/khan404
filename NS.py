...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> NOYSHIM/USMII TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[NOYSHIM/ USMI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
